...
{
    public static final int MAXBITS = 175;    // maxima cantidad de bits que aceptamos para un cdigo
    private byte bits[];                      // aca guardamos los bits, de atrs hacia adelante
    private int startPos;                     // indica dnde comienza la cadena de bits dentro del vector 
    ...
    public void setBit(byte bit)
    {
        if (startPos == 0) 
        {
            ...
            //System.out.println("Cdigo muy largo");
            System.exit(1);
        }
        startPos--;
        bits[startPos] = bit;
