...
public class NodoHuffman
{
    ...
    private int  padre;         // indice del padre dentro del arreglo que soporta al �rbol
    private boolean esIzquierdo;   // indica si este nodo es hijo izquierdo o no de su padre
    
    private int izq, der;       // para la fase de decodificaci�n, necesito los �ndices de los hijos
    ...
    public NodoHuffman()
    {
        padre = -1;             // a�n no hay padre definido
        izq = der = -1;         // a�n no hay hijos definidos
    }
